@extends('admin.v1.layout.app', ['title' => 'Add Agent'])
...
<section class="content-header">
  <h1>
    ...
    <?php if($type == "edit") {
      ?><small>Edit Agent</small><?php
    } else {
      ?><small>Add New Agent</small><?php
    } ?>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <?php if($type == "edit") {
      ?><li class="active">Edit Agent</li><?php
    } else {
      ?><li class="active">Add New Agent</li><?php
    } ?>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-body">
        <?php if($type == "edit") {  ?>
        <form method="post" action="{{ route('agent.update',[$pinfo->id]) }}" enctype="multipart/form-data">
        <?php } else { ?>
                ...
                <!-- <center> -->
                  <div class="fbpickermain">
                      <div class=fbpiker>
                          ...
                          <img id="fbholdernew" data-default="{{ @$pinfo->photo ? asset($pinfo->photo) : asset('user_404.jpg') }}" src="{{ @$pinfo->photo ? asset($pinfo->photo) : asset('user_404.jpg') }}"  onclick="triggerfile('fbholdernew','fbinputtxt','image/agent/','.jpg,.png,.jpeg','box')">
                      </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                      <label for="person_name">Agent Name <?= COMPICON ?></label>
...
<div class="buy-now">
<a href="{{ route('agent') }}" class="btn btn-primary buy-now-btn">
