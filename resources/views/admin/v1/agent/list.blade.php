@extends('admin.v1.layout.app', ['title' => 'Agent'])
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">List of Agent</h3>
...
<div class="buy-now">
<a href="{{ route('agent.new') }}" class="btn btn-primary buy-now-btn">
  ...
  // alert('hello');
    ...
    type:'POST'
	  ...
	  .done(function(e) {
		if(e)
		{
			toastr.success("Agent "+status_txt+" Successfully.");
		}
		else
		{
			toastr.error('Ooops..! Something went wrong');
