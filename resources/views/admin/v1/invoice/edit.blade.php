    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="{{ route('update.invoice',$info->id) }}" enctype="multipart/form-data">
              {!! csrf_field() !!}
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    <label>Payment Type</label>
                    <input type="checkbox" value="1" id="confirmAns" name="confirmAns" class="confirmAns" {{ $info->type == 1 ? "checked" : ""  }} data-size="mini" data-toggle="toggle" data-on="Cash" data-off="Credit" data-onstyle="success" data-offstyle="info">
                  </div>
                </div>
              </div>
              <div class="row">
                    ...
                    <div class="input-group">
                      ...
                      <select id="agent_name" name="agent_name" class="form-control select2-bank" data-placeholder="Select Agent">
                        ...
                        @foreach($agent_list as $row)
                          <option data-state="{{ $row->state  }}" data-business="{{ $row->business_name }}" data-img="{{ $row->photo }}" value="{{ $row->id }}" {{ $info->agent_id == $row->id ? "selected" : "" }}>{{ ucwords($row->name) }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <select  style="width: 100%;" id="process_state" name="process_state" class="form-control select2">
                        ...
                        ?>
                        <option value="{{ $row->state_id }}" data-gst="{{ $row->gst_code }}" {{ @$pinfo->state == $row->state_id ? "selected" : "" }} {{ $info->state == $row->state_id ? "selected" : "" }}>{{ $row->state }}</option>
                        <?php
                        }
                        ?>
                      </select>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                      <input type="text" id="dc_no" name="dc_no" value="{{ $info->delivery_no }}" class="form-control">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-striped mytbl fixtablemobile2">
                      ...
                      <tr class="tblrow{{ $no_new }}" data-id="{{ $no_new++ }}">
                        ...
                        <td class="ele2">
                          <div class="form-group">
                            <input type="text" id="description" value="{{ $re->description }}" name="description[]" class="form-control description text-center" autocomplete="false">
                          </div>
                        </td>
                        <td class="ele3">
                          <div class="form-group">
                            <input type="text" id="design_name" value="{{ $re->design_name }}" name="design_name[]" class="form-control design_name text-center" autocomplete="false">
                          </div>
                        </td>
                        <td class="ele4">
                          <div class="form-group">
                            <input type="text" id="hsn_no" name="hsn_no[]" value="{{ $re->hsn_code }}" class="form-control hsn_no text-center" autocomplete="false">
                          </div>
                        </td>
                        <td class="ele5">
                          <div class="form-group">
                            <input type="text" id="quantity" name="quantity[]" value="{{ $re->quantity }}" class="form-control quantity onlyint text-center checkcalculation" autocomplete="false">
                          </div>
                        </td>
                        <td class="ele6">
                          <div class="form-group">
                        ...
                        <td class="ele10">
                          <div class="form-group">
                            <input type="text" id="length" name="length[]" value="{{ $re->item_length }}" class="form-control length onlyint text-center checkcalculation" autocomplete="false">
                          </div>
                        </td>
                        <td class="ele7">
                          <div class="form-group">
                            <input type="text" id="unit" name="unit[]" value="{{ $re->rate }}" class="form-control unit onlyint text-center checkcalculation" autocomplete="false">
                          </div>
                        </td>
                        <td class="ele11">
                          <div class="form-group">
                            <input type="text" id="discount" name="discount[]" value="{{ $re->discount }}" class="form-control discount onlyint text-center checkcalculation" maxlength='2' autocomplete="false">
                          </div>
                        </td>
                        <td class="ele12">
                          <div class="form-group">
                            <input type="text" id="gst" name="gst[]" value="{{ $re->gst }}" class="form-control gst onlyint text-center checkcalculation" maxlength='2' autocomplete="false">
                          </div>
                        </td>
                        <td class="ele8">
                          <div class="form-group">
                            <input type="text" id="total" name="total[]" readonly value="{{ $re->total }}" class="form-control total onlyint text-center checkcalculation" autocomplete="false">
                          </div>
                        </td>
                        <td class="ele9">
                    ...
                    <div class="col-md-12">
                      <div class="form-group pull-right">
                        ...
                        <div class="input-group">
                          ...
                          <input type="text" class="form-control onlyint text-center" readonly value="{{ $info->sub_total }}" id="grand_total" name="grand_total">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group mt-sm pull-right">
                        ...
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                          <input type="text" class="form-control onlyint text-center" value="{{ $info->discount_amount }}" id="loss_amount" name="loss_amount">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group mt-sm pull-right">
                        ...
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                          <input type="text" class="form-control onlyint text-center" value="{{ $info->tax_total }}" id="grand_tax" name="grand_tax">
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-group mt-sm pull-right">
                        ...
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-inr"></i></span>
                          <input type="text" readonly class="form-control onlyint text-center" value="{{ $info->grand_total }}" id="main_total" name="main_total">
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <script type="text/javascript">
    ...
    $(document).on("click",".removerowpayment",function(e) {
      ...
      if(ele.attr('data-id')) {
        ...
        if(conf) {
          var route = '{{ route('delete.invoice.payment',":ID") }}';
