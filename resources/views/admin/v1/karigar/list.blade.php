...
<section class="content-header">
  <h1>
    ...
    <small>Manage Karigar</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Karigar</li>
  </ol>
</section>
  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">List of Karigar</h3>
...
<div class="buy-now">
<a href="{{ route('karigar.new') }}" class="btn btn-primary buy-now-btn">
  ...
  // alert('hello');
    ...
    type:'POST'
	  ...
	  .done(function(e) {
		if(e)
		{
			toastr.success("Karigar "+status_txt+" Successfully.");
		}
		else
		{
			toastr.error('Ooops..! Something went wrong');
...
$(document).ready(function() {
  table = $('.dtable').DataTable({
    ...
    "serverSide" : true,
    "order" : [],
    "ajax" : "{{ route('karigar.list.ajax') }}",
    "bLengthChange": false,
    "bAutoWidth": false,
    "columns" : [
      {"data":"party","sWidth": "30%"},
      {"data":"transection_amount","sWidth": "15%"},
      {"data":"gstininfo","sWidth": "15%"},
      {"data":"contactinfo","sWidth": "15%"},
...
var user_id = data.id;
if(user_id) {
  var route = '{{ route('karigar.view',":ID") }}';
