@extends('admin.v1.layout.app', ['title' => 'Expenses Unit'])
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-outdent"></i> Expenses Unit
            <small>Manage Expenses Unit</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Expenses Unit</li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Expenses Unit</h3>
                    ...
                    <div class="box-body">
                        <form method="post" action="{{ route('expenses.types.register') }}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
                            <div class="form-group">
                                <label for="type_name">Unit Name</label>
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Expenses Unit</h3>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Update Expenses Unit</h4>
                </div>
                <form method="post" action="{{ route('expenses.types.update') }}" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="edit_type_name">Unit Name</label>
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
    ...
    <script type="text/javascript">
        ...
        var dtable_lang = {
            search: "_INPUT_",
            searchPlaceholder: "Search Expenses Unit"
        };
