...
@section('content')
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-sign-out"></i> Add Expenses
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <div class="box-body">
            <form method="post" action="{{ route('register.expenses') }}" enctype="multipart/form-data">
              {!! csrf_field() !!}
              <div class="row">
                <div class="col-md-12">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" id="bill_no" name="bill_no" value="" class="form-control">
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <label for="ref_img">Bill Ref. Image</label>
