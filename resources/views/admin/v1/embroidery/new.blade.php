...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-body">
        <form method="post" action="{{ route('register.embroidery.design') }}" enctype="multipart/form-data">
          {!! csrf_field() !!}
          <div class="row">
            <div class="col-md-4">
              <!-- File Input -->
              <div class="fbpickermain">
                <div class=fbpiker>
                  ...
                  <img id="fbholdernew" data-default="{{ asset('placeholder.jpg') }}" src="{{ asset('placeholder.jpg') }}"  onclick="triggerfile('fbholdernew','fbinputtxt','image/design/','.jpg,.png,.jpeg','box')">
                </div>
                <input id="fbinputtxt" name="fbinputtxt" class='fbinputtxt' value="{{ asset('placeholder.jpg')  }}" type="hidden" >
              </div>
              <!-- end of File Input -->
            </div>
            <div class="col-md-8">
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                        ...
                        <input type="text" id="design_name" name="design_name" value="" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                        ...
                        <input type="text" id="master_user" name="master_user" class="form-control">
                        </div>
                    </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" id="stitch" name="stitch" value="" class="form-control">
                </div>
            </div>
            </div>
            <div class="col-md-4">
