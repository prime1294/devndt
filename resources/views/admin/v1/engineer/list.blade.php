  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">List of Engineer</h3>
...
<div class="buy-now">
<a href="{{ route('engineer.new') }}" class="btn btn-primary buy-now-btn">
  ...
  // alert('hello');
    ...
    type:'POST'
	  ...
	  .done(function(e) {
		if(e)
		{
			toastr.success("Engineer "+status_txt+" Successfully.");
		}
		else
		{
			toastr.error('Ooops..! Something went wrong');
...
var user_id = data.id;
if(user_id) {
  var route = '{{ route('engineer.view',":ID") }}';
