...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-body">
        <form method="post" action="{{ route('register.fashion.design') }}" enctype="multipart/form-data">
          {!! csrf_field() !!}
          <div class="row">
            <div class="col-md-4">
              <!-- File Input -->
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="sale_price" name="sale_price" value="" class="form-control onlyint">
                    </div>
                </div>
                </div>
                <div class="col-md-12">
