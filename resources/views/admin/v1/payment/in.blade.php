@extends('admin.v1.layout.app', ['title' => 'Payment In'])
...
<section class="content-header">
  <h1>
    <i class="fa fa-inr"></i> Payment In
    <small>Adjust Your Payment</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Payment In</li>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-body">
        <form method="post" action="{{ route('paymentin.register') }}" enctype="multipart/form-data">
          {!! csrf_field() !!}
          <div class="row">
            <div class="col-md-4">
