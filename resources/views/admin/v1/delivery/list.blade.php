...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-list-alt"></i> Delivery Challan
            <small>Delivery Challan List</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <div class="buy-now">
        <a href="{{ route('add.delivery.challan') }}" class="btn btn-primary buy-now-btn">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            dtable = $('.dtable').DataTable({
                ...
                "bAutoWidth": false,
                "columns" : [
                    {"data":"formated_date","sWidth": "10%"},
                    {"data":"formated_process","sWidth": "15%"},
                    {"data":"formate_stock","sWidth": "35%"},
                    {"data":"formated_grand_total","sWidth": "10%"},
