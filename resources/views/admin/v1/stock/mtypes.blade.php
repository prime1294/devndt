@extends('admin.v1.layout.app', ['title' => 'Stock Unit'])
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-balance-scale"></i> Stock Unit
            <small>Manage Stock Unit</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Stock Unit</h3>
                    ...
                    <div class="box-body">
                        <form method="post" action="{{ route('stock.types.register') }}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Stock Unit</h3>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Update Stock Unit</h4>
                </div>
                <form method="post" action="{{ route('stock.types.update') }}" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        ...
        var dtable_lang = {
            search: "_INPUT_",
            searchPlaceholder: "Search Stock Unit"
        };
