@extends('admin.v1.layout.app', ['title' => 'Edit Stock'])
...
<section class="content-header">
  <h1>
    <i class="fa fa-cubes"></i> Edit Stock
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-body">
        <form method="post" action="{{ route('stock.update',["id"=>$party_info->id,"uid"=>$stock_info->id]) }}" enctype="multipart/form-data">
          {!! csrf_field() !!}
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" id="adjustment_date" name="adjustment_date" value="{{ date('d-m-Y',strtotime($stock_info->as_of)) }}" class="form-control datepicker">
                </div>
              </div>
              </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" id="challan_no" name="challan_no" value="{{ $stock_info->challan_no }}" class="form-control">
                </div>
              </div>
              </div>
            <div class="col-md-4">
              <div class="form-group">
                    <label for="ref_img">Update Challan Photo <a href="{{ asset($stock_info->challan_photo) }}" target="_blank">View Current</a></label>
                    ...
                    <input type="hidden" id="upload_challanphotobtn" name="upload_challanphotobtn" value="{{ $stock_info->challan_photo }}">
                </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                    ...
                    <select id="agent" name="agent" class="form-control select2-bank" data-placeholder="Select User">
                      ...
                      <option data-img="{{ $row->photo }}" value="{{ $row->id }}" {{ $row->id == $stock_info->agent_id ? "selected" : "" }}>{{ ucwords($row->name) }}</option>
                      @endforeach
                    </select>
                    </div>
                </div>
            ...
            <div class="col-md-4">
              <div class="form-group">
                    ...
                    <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                    <input type="text" id="transport" name="transport" value="{{ $stock_info->transport_id }}" class="form-control">
                    </div>
                </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" id="lrno" name="lrno" value="{{ $stock_info->lrno }}" class="form-control">
                </div>
              </div>
              </div>
          </div>
          ...
          <div class="row">
              <div class="col-md-4">
                  <div class="form-group">
                      ...
                      <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                          <input type="text" id="complete_date" name="complete_date" value="{{ date('d-m-Y',strtotime($stock_info->complete_date)) }}" class="form-control datepicker">
                      </div>
                  </div>
              </div>
            <div class="col-md-4">
              <div class="form-group">
                    <label for="ref_img">Update Sample Photo <a href="{{ asset($stock_info->sample_photo) }}" target="_blank">View Current</a></label>
                    ...
                    <input type="hidden" id="upload_image_text" name="upload_image_text" value="{{ $stock_info->sample_photo }}">
                </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
                ...
                <div class="input-group">
                <span class="input-group-addon"><i class="fa fa-user"></i></span>
                <input type="text" id="location" name="location" value="{{ $stock_info->location }}" class="form-control">
                </div>
              </div>
              </div>
          </div>
          ...
          <div class="row mt-sm">
            <div class="col-md-12">
              <div class="form-group">
                    ...
                    <textarea id="remarks" name="remarks" class="form-control" rows="2">{{ $stock_info->remarks }}</textarea>
                </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="fbpickermain">
                ...
                <input id="fbinputtxt" name="fbinputtxt" value="placeholder.jpg" class='fbinputtxt' type="hidden" >
              </div>
            </div>
            <!-- end of file upload -->
            <div class="col-md-3">
