...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-body">
        <form method="post" action="{{ route('settlement.register',["id"=>$info->id,"uid"=>$party_info->id]) }}" enctype="multipart/form-data">
          ...
          {!! csrf_field() !!}
            ...
            <div class="qunatity_holder mt-sm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="text" id="measurement" name="measurement[]" placeholder="Unit" value="{{ $row->unit }}" class="imeasurement form-control onlyint">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="text" id="colors" name="colors[]" placeholder="Colors" value="{{ $row->color }}" class="icolorfirst form-control">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <input type="text" id="design" name="design[]" placeholder="Design" value="{{ $row->design }}" class="idesignfirst form-control">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="text" id="adjustment_date" name="adjustment_date[]" value="{{ date('d-m-Y',strtotime("now")) }}" placeholder="Date" class="form-control datepicker">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <input type="text" id="design" name="design[]" placeholder="Design" class="idesignfirst form-control">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <input type="text" id="remarks" name="remarks[]" placeholder="Remarks" value="" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-1">
                            <div class="form-group">
...
function add_quantity() {
    ...
    html += '<div class="row">';
        ...
        html += '<input type="text" id="adjustment_date" name="adjustment_date[]" value="'+dd+'-'+mm+'-'+yyyy+'" placeholder="Date" class="form-control datepicker">';
        html += '</div>';
        html += '</div>';
        html += '<div class="col-md-2">';
        html += '<div class="form-group">';
        html += '<input type="text" id="measurement" name="measurement[]" placeholder="Unit" value="" class="imeasurement form-control onlyint">';
        html += '</div>';
        html += '</div>';
        html += '<div class="col-md-2">';
        html += '<div class="form-group">';
        html += '<input type="text" id="colors" name="colors[]" placeholder="Colors" value="" class="icolorfirst form-control">';
        html += '</div>';
        html += '</div>';
        html += '<div class="col-md-2">';
        html += '<div class="form-group">';
        html += '<input type="text" id="design" name="design[]" placeholder="Design" class="idesignfirst form-control">';
        html += '</div>';
        html += '</div>';
        html += '<div class="col-md-3">';
        html += '<div class="form-group">';
        html += '<input type="text" id="remarks" name="remarks[]" placeholder="Remarks" value="" class="form-control">';
        html += '</div>';
        html += '</div>';
...
function val_add_party() {
    ...
    if((total <= $("#current_stock").val()) === false) {
        toastr.error("Settlement quantity limit exceed");
        return false;
    }
