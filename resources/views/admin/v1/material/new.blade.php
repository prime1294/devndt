@extends('admin.v1.layout.app', ['title' => 'Add Material'])
...
<section class="content-header">
  <h1>
    ...
    <?php if($type == "edit") {
      ?><small>Edit Material</small><?php
    } else {
      ?><small>Add New Material</small><?php
    } ?>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <?php if($type == "edit") {
      ?><li class="active">Edit Material</li><?php
    } else {
      ?><li class="active">Add New Material</li><?php
    } ?>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-body">
        <?php if($type == "edit") {  ?>
        <form method="post" action="{{ route('material.update',[$pinfo->id]) }}" enctype="multipart/form-data">
        <?php } else { ?>
        <form method="post" action="{{ route('material.register') }}" enctype="multipart/form-data">
        <?php } ?>
          {!! csrf_field() !!}
            <div class="row">
              <div class="col-md-12">
                <!-- <center> -->
                  <div class="fbpickermain">
                      <div class=fbpiker>
                          ...
                          <img id="fbholdernew" data-default="{{ asset('user_404.jpg') }}" src="{{ asset('user_404.jpg') }}"  onclick="triggerfile('fbholdernew','fbinputtxt','image/material/','.jpg,.png,.jpeg','box')">
                      </div>
                      <input id="fbinputtxt" name="fbinputtxt" class='fbinputtxt' type="hidden" >
                  </div>
                <!-- </center> -->
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                      <label for="type_of_manufacturer">Type of Material</label>
                      <div class="input-group">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                      ...
                      <input type="text" id="gstno" name="gstno" class="form-control"  maxlength="15" onpaste="verifyGST(this)" value="{{ @$pinfo->gstin_no }}">
                      </div>
                  </div>
              </div>
