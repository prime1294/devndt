@extends('admin.v1.layout.app', ['title' => 'Material Types'])
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-object-ungroup"></i> Material Types
            <small>Manage Material Types</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Material Types</li>
        </ol>
    </section>
            ...
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Material Types</h3>
                    ...
                    <div class="box-body">
                        <form method="post" action="{{ route('material.types.register') }}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Update Material Types</h4>
                </div>
                <form method="post" action="{{ route('material.types.update') }}" enctype="multipart/form-data">
