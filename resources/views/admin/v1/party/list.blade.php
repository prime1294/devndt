  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-header with-border">
        <h3 class="box-title">List of Party</h3>
          ...
          <table class="table table-hover table-striped table-bordered dtable tbldblclick fixtablemobile">
            <thead>
                <tr>
                  ...
                  <th data-orderable="false">Manufacturer</th>
...
<div class="buy-now">
<a href="{{ route('party.new') }}" class="btn btn-primary buy-now-btn">
  ...
  // alert('hello');
    ...
    type:'POST'
	  ...
	  .done(function(e) {
		if(e)
		{
			toastr.success("Party "+status_txt+" Successfully.");
		}
		else
		{
			toastr.error('Ooops..! Something went wrong');
