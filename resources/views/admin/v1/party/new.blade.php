@extends('admin.v1.layout.app', ['title' => 'Add Party'])
...
<section class="content-header">
  <h1>
    ...
    <?php if($type == "edit") {
      ?><small>Edit Party</small><?php
    } else {
      ?><small>Add New Party</small><?php
    } ?>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <?php if($type == "edit") {
      ?><li class="active">Edit Party</li><?php
    } else {
      ?><li class="active">Add New Party</li><?php
    } ?>
...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box-body">
        <?php if($type == "edit") {  ?>
        <form method="post" action="{{ route('party.update',[$pinfo->id]) }}" enctype="multipart/form-data">
        <?php } else { ?>
        <form method="post" action="{{ route('party.register') }}" enctype="multipart/form-data">
        <?php } ?>
          {!! csrf_field() !!}
            <div class="row">
              <div class="col-md-12">
                <!-- <center> -->
                  <div class="fbpickermain">
                      <div class=fbpiker>
                          ...
                          <img id="fbholdernew" data-default="{{ @$pinfo->photo ? asset($pinfo->photo) : asset('user_404.jpg') }}" src="{{ @$pinfo->photo ? asset($pinfo->photo) : asset('user_404.jpg') }}"  onclick="triggerfile('fbholdernew','fbinputtxt','image/party/','.jpg,.png,.jpeg','box')">
                      </div>
...
{{--                  </div>--}}
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                      <label for="type_of_manufacturer">Types of Manufacturer</label>
                      <div class="input-group">
                      <span class="input-group-addon"><i class="fa fa-sitemap"></i></span>
                      <select id="type_of_manufacturer" multiple="multiple" name="type_of_manufacturer[]" class="form-control select2" style="width: 100%;">
                        <?php
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                      ...
                      <div class="input-group">
                      <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                      <input type="text" id="alt_no" name="alt_no" class="form-control onlyint" value="{{ @$pinfo->alt_mobile }}">
                      </div>
                  </div>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="form-group">
                      ...
                      <input type="text" id="gstno" maxlength="15" name="gstno" onpaste="verifyGST(this)" onkeyup="this.value = this.value.toUpperCase();" class="form-control" value="{{ @$pinfo->gstin_no }}">
                      </div>
                  </div>
              </div>
