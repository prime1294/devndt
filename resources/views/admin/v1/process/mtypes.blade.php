@extends('admin.v1.layout.app', ['title' => 'Process Types'])
...
@section('content')
    ...
    <section class="content-header">
        <h1>
            <i class="fa fa-tasks"></i> Process Types
            <small>Manage Process Types</small>
        </h1>
        <ol class="breadcrumb">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-4">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Process Types</h3>
                    ...
                    <div class="box-body">
                        <form method="post" action="{{ route('process.types.register') }}" enctype="multipart/form-data">
                            {!! csrf_field() !!}
            ...
            <div class="col-md-8">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Process Types</h3>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Update Process Types</h4>
                </div>
                <form method="post" action="{{ route('process.types.update') }}" enctype="multipart/form-data">
