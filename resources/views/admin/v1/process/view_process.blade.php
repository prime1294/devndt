@extends('admin.v1.layout.app', ['title' => 'Process'])
...
<section class="content-header">
  <h1>
    <i class="fa fa-list-alt"></i> Manage Process
    <small>Manage All Process</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="{{ route('user.dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
    <li class="active">Manage Process</li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      ...
      <div class="box-body">
        ...
        <div class="table-responsive">
          <table class="table table-hover table-striped table-bordered dtable rmmobrowpadding fixtablemobile2">
            <thead>
                <tr>
                  <th data-orderable="false">Date</th>
                  <th data-orderable="false">Process</th>
...
<div class="buy-now">
<a href="{{ route('add.new.process') }}" class="btn btn-primary buy-now-btn">
...
$(document).ready(function() {
  dtable = $('.dtable').DataTable({
    ...
    "bAutoWidth": false,
    "columns" : [
      {"data":"formated_date","sWidth": "7%"},
      {"data":"formated_process","sWidth": "15%"},
      {"data":"formate_stock","sWidth": "36%"},
      {"data":"formated_grand_total","sWidth": "8%"},
      {"data":"formated_payment_total","sWidth": "8%"},
      {"data":"formated_balance_total","sWidth": "8%"},
      {"data":"action", "searchable": false , "orderable": false,"sWidth": "26%"},
    ]
  });
});
