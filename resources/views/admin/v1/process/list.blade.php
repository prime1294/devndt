          ...
          <table class="table table-hover table-striped table-bordered dtable tbldblclick fixtablemobile">
            <thead>
                <tr>
                  ...
                  <th data-orderable="false">Type of Process</th>
...
<div class="buy-now">
<a href="{{ route('process.new') }}" class="btn btn-primary buy-now-btn">
  ...
  // alert('hello');
    ...
    type:'POST'
	  ...
	  .done(function(e) {
		if(e)
		{
			toastr.success("Process "+status_txt+" Successfully.");
		}
		else
		{
			toastr.error('Ooops..! Something went wrong');
...
var user_id = data.id;
if(user_id) {
  var route = '{{ route('process.view',":ID") }}';
